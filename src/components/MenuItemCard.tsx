        ...
        <div className="relative h-48 bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            {item.isOnDiscount && item.discountPrice && (
              <div className="bg-gradient-to-r from-sweet-green to-sweet-green-dark text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg animate-pulse">
                SALE
              </div>
            )}
            {item.popular && (
          ...
          {!item.available && (
            <div className="absolute top-3 right-3 bg-sweet-green text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg">
              UNAVAILABLE
            </div>
          )}
          ...
          {item.isOnDiscount && item.discountPrice && (
            <div className="absolute bottom-3 right-3 bg-white/90 backdrop-blur-sm text-sweet-green text-xs font-bold px-2 py-1 rounded-full shadow-lg">
              ...
              {item.isOnDiscount && item.discountPrice ? (
                <div className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <span className="text-2xl font-bold text-sweet-green">
            ...
            <div className="flex-shrink-0">
              {!item.available ? (
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-sweet-green to-sweet-green-dark text-white px-6 py-2.5 rounded-xl hover:from-sweet-green-dark hover:to-sweet-green transition-all duration-200 transform hover:scale-105 font-medium text-sm shadow-lg hover:shadow-xl"
                >
            ...
            <div className="p-6">
                      ...
                      <label
                        ...
                        className={`flex items-center justify-between p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                          selectedVariation?.id === variation.id
                            ? 'border-sweet-green bg-sweet-green-light'
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          <input
                            ...
                            className="text-sweet-green focus:ring-sweet-green"
                          />
                          ...
                          >
                            ...
                            <div className="flex items-center space-x-2">
                              {selectedAddOns.find(a => a.id === addOn.id) ? (
                                <div className="flex items-center space-x-2 bg-sweet-green-light rounded-xl p-1 border border-sweet-green">
                                  <button
                                    type="button"
                                    onClick={() => {
                                    ...
                                    className="p-1.5 hover:bg-sweet-green rounded-lg transition-colors duration-200"
                                  >
                                    <Minus className="h-3 w-3 text-sweet-green" />
                                  </button>
                                  ...
                                  <button
                                    ...
                                    className="p-1.5 hover:bg-sweet-green rounded-lg transition-colors duration-200"
                                  >
                                    <Plus className="h-3 w-3 text-sweet-green" />
                                  </button>
                                </div>
                              ) : (
                                <button
                                  ...
                                  className="flex items-center space-x-1 px-4 py-2 bg-gradient-to-r from-sweet-green to-sweet-green-dark text-white rounded-xl hover:from-sweet-green-dark hover:to-sweet-green transition-all duration-200 text-sm font-medium shadow-lg"
                                >
              ...
              <div className="border-t border-gray-200 pt-4 mb-6">
                <div className="flex items-center justify-between text-2xl font-bold text-gray-900">
                  <span>Total:</span>
                  <span className="text-sweet-green">₱{calculatePrice().toFixed(2)}</span>
                </div>
              </div>

              <button
                onClick={handleCustomizedAddToCart}
                className="w-full bg-gradient-to-r from-sweet-green to-sweet-green-dark text-white py-4 rounded-xl hover:from-sweet-green-dark hover:to-sweet-green transition-all duration-200 font-semibold flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
